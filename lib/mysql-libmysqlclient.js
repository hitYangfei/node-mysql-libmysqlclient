...
try {
  ...
  // For node < v0.5.5
  // not only the version of node will throw execption if 
  // the modules can not find libmysqlclient.so will also 
  // throw execption . So I think log it will be helpful 
  console.log(e);
  try {
